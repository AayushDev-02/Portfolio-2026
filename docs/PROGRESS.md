...
- **Current stage:** Stage 2R — FIXES-STAGE2.md §§1–8 are done and committed. Only the visual sign-off is left.
- **Next action:** put the build side by side with https://www.project-uncensored.site/ at 1440 / 768 / 390 and **look at them**. That is Stage 2R's DoD and the exact check that failed the first time — measurements alone were what let a fully inverted palette pass review.
...
- [ ] Side-by-side at 1440 / 768 / 390 — **verified by looking, not by diffing numbers**
