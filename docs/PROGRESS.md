...
- **Next action:** SETUP.md step 3 — vercel.com → Add New → Project → import `Portfolio-2026` → Framework preset Next.js → Deploy. Paste the `.vercel.app` URL below.
- **Live URL:** —
