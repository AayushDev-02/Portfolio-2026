...
- **Current stage:** Stage 1 — Design system (mostly done, needs local verification)
- **Next action:** run `pnpm install && pnpm dev`, check `/dev/kitchen-sink`, then do SETUP.md steps 2–3 (GitHub + Vercel)
- **Live URL:** —
- **Repo:** —
...
## Stage 0 — Foundation
- [ ] Node 20+ LTS, pnpm, git verified on laptop — `pnpm install` will confirm
- [x] Next.js 15 app scaffolded (TS, Tailwind v4, App Router, src/)
- [x] Biome + strict tsconfig + path aliases
- [x] docs/ committed
- [ ] `pnpm install && pnpm dev` runs clean locally  ← **do this first**
- [ ] Public GitHub repo created and pushed  ← SETUP.md step 2
- [ ] Vercel connected, first preview deploy green  ← SETUP.md step 3
...
- [ ] Visually verified in a browser  ← **blocked on `pnpm install`**
