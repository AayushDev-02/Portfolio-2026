...
- **Current stage:** **Stages 6, 7, 8 and 11 are DONE.** Dark mode shipped 2026-08-30 — a token-override block, no component colour edits, 0 axe violations in all four theme/locale combinations. Both locales score Performance 98 / Accessibility 100 / Best Practices 100 / SEO 100, all four now hard-asserted in CI. Next is Stage 9 (launch). Stage 5 is still open on two human items.
