...
const skills = {
  ...
  layers: [
    ...
    {
      name: "API & Services",
      note: "Between the browser and the model",
      emphasis: false,
      items: [
        "Python",
        "Java",
    ...
    {
      name: "AI & Retrieval",
      note: "Where the accuracy work actually is",
      emphasis: true,
      items: [
    ...
    {
      name: "Data",
      note: "What the answers are grounded in",
      emphasis: false,
      items: [
        "SQL",
        "PostgreSQL",
    ...
    {
      name: "Cloud & Delivery",
      note: "How it reaches production and stays there",
      emphasis: false,
      items: [
        "AWS",
        "Microsoft Azure",
  ...
  ] satisfies SkillLayer[],
  diagram: {
    title: "The stack, in five layers",
    desc: "Five layers, drawn from the browser downwards. Frontend: TypeScript, JavaScript, React, Next.js, Vue.js, Vite, Tailwind CSS, MapLibre, Mapbox and Apache ECharts. API and services: Python, Java, C++, FastAPI, Node.js, Express.js, Django, Flask, Spring Boot, REST APIs and async and multithreaded processing. AI and retrieval, the emphasised layer: retrieval-augmented generation, large language models, LangChain, the OpenAI API, prompt engineering, function calling, embeddings, chunking and reranking, semantic and hybrid vector search, pgvector, index tuning, retrieval evaluation, retrieval pipeline optimisation, OCR pipelines and self-hosted models. Data: SQL, PostgreSQL, MySQL, MongoDB, Redis, PostGIS, QGIS, pandas, NumPy and PyMuPDF. Cloud and delivery: AWS, Microsoft Azure, Docker, GitHub Actions, CI/CD, DigitalOcean, Vercel, Cloudflare and Bash.",
  } satisfies StackDiagram,
